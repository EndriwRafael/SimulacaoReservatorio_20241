...
class NumericalAnalysis:
    ...
    def plot_results(self, data: Df):
        ...
        plt.grid()
        plt.tight_layout()
        plt.savefig(f'results\\Simulador_Fluxo-Fluxo\\fluxo-fluxo_numerico.png')
        plt.close()

        data.to_excel(f'results\\Simulador_Fluxo-Fluxo\\fluxo-fluxo_numerico.xlsx')
