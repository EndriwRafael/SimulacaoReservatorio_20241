...
case.set_case_parameters(initial_press=pressure_initial, well_press=pressure_well, res_area=area, res_thick=thickness,
                         porosity=porosit, viscosity=viscosi, compressibility=compressibi, permeability=permeabi,
                         res_len=length_reser_x, res_width=length_reser_y, baseflow=qbase, leftflow=qleft,
                         rightflow=qright, topflow=qtop)
